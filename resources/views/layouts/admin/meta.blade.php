...
<head>
    ...
    <link href="{{ asset('sb-template/css/my-script.css') }}" rel="stylesheet">

    <!-- DataTabels -->
    <link href="{{ asset('sb-template/vendor/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
